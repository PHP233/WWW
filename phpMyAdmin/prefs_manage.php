...
<div id="maincontainer">
    <div id="main_pane_left">
        ...
        if (file_exists('./setup/index.php')) {
            // show only if setup scripts is available, allows to disable this message
        ...
        <div class="group">
            ...
            <div class="group-cnt">
                <?php
                echo sprintf(__('You can set more settings by modifying config.inc.php, eg. by using %sSetup scripts%s.'), '<a href="setup/index.php">', '</a>');
