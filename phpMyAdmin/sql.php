 ...
 *
 * This part of the scripts is bypassed if $is_js_confirmed = 1 (already checked
...
if (isset($GLOBALS['show_as_php']) || ! empty($GLOBALS['validatequery'])) {
    ...
    // Displays an error message if required and stop parsing the scripts
...
if ((0 == $num_rows && 0 == $unlim_num_rows) || $is_affected) {
    ...
    if ($is_gotofile) {
        ...
        // Checks for a valid target scripts
