 ...
 * // note the ?
 * echo 'scripts.php?' . PMA_generate_common_url('mysql', 'rights');
 * // produces with cookies enabled:
 * // scripts.php?db=mysql&amp;table=rights
 * // with cookies disabled:
 * // scripts.php?server=1&amp;lang=en&amp;db=mysql&amp;table=rights
 *
 * // NEW style
 ...
 * $params['table']   = 'rights';
 * // note the missing ?
 * echo 'scripts.php' . PMA_generate_common_url($params);
 * // produces with cookies enabled:
 * // scripts.php?myparam=myvalue&amp;db=mysql&amp;table=rights
 * // with cookies disabled:
 * // scripts.php?server=1&amp;lang=en&amp;myparam=myvalue&amp;db=mysql&amp;table=rights
 *
 * // note the missing ?
 * echo 'scripts.php' . PMA_generate_common_url();
 * // produces with cookies enabled:
 * // scripts.php
 * // with cookies disabled:
 * // scripts.php?server=1&amp;lang=en
 * </code>
 *
