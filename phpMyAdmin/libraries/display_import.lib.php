...
?>
    ...
    <div class="importoptions">
        ...
        <div class="formelementrow">
            ...
            <label for="checkbox_allow_interrupt"><?php echo __('Allow the interruption of an import in case the scripts detects it is close to the PHP timeout limit. <i>(This might be a good way to import large files, however it can break transactions.)</i>'); ?></label><br />
        </div>
