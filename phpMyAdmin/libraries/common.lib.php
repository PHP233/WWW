...
function PMA_reloadNavigation($jsonly=false)
{
    ...
    if (isset($GLOBALS['reload']) && $GLOBALS['reload']) {
        ...
        if (!$jsonly) {
            echo '<scripts type="text/javascript">' . PHP_EOL;
        }
    ?>
//<![CDATA[
 ...
 * Called by each scripts that needs parameters, it displays
 * an error message and, by default, stops the execution.
 *
 * Not sure we could use a strMissingParameter message here,
 * would have to check if the error message file is always available
 *
 * @param array $params  The names of the parameters needed by the calling scripts.
 * @param bool  $die     Stop the execution?
 *                       (Set this manually to false in the calling scripts
 ...
 *
 * @global  string  path to current scripts
 ...
 * @param string $script      scripts name for form target
...
/**
 * Get the action word corresponding to a scripts name
...
/**
 * function that generates a json output for an ajax request and ends scripts
 * execution
 *
