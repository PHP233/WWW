 ...
 * MUST be included by every scripts
 *
...
/**
 * block attempts to directly run this scripts
 */
...
if (isset($_POST['usesubform'])) {
     ...
     * include this page at the end of this scripts - we use $__redirect to
     * track this
     */
...
/**
 * Add common jQuery functions scripts here if necessary.
 */
