 ...
 *
 * WARNING: This scripts has to be included at the very end of your code because
 *          it will stop the scripts execution!
 *
 * always use $GLOBALS, as this scripts is also included by functions
 *
 * @package PhpMyAdmin
 */
