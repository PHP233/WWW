...
$strConfigExecTimeLimit_desc = __('Set the number of seconds a scripts is allowed to run ([kbd]0[/kbd] for no limit)');
...
$strConfigImport_allow_interrupt_desc = __('Allow interrupt of import in case scripts detects it is close to time limit. This might be a good way to import large files, however it can break transactions.');
...
$strConfigMemoryLimit_desc = __('The number of bytes a scripts is allowed to allocate, eg. [kbd]32M[/kbd] ([kbd]0[/kbd] for no limit)');
