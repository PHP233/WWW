 ...
 * enclosed by <![CDATA[ ... ]]>
 * this requires only to escape ' with \' and end of scripts block
 *
 * We also remove NUL byte as some browsers (namely MSIE) ignore it and
 * inserting it anywhere inside </scripts would allow to bypass this check.
 *
...
{
    return preg_replace('@</scripts@i', '</\' + \'scripts',
                        strtr($string, array(
                                "\000" => '',
                                '\\' => '\\\\',
                                '\'' => '\\\'',
