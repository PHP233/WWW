...
// Handles some variables that may have been sent by the calling scripts
$GLOBALS['db'] = '';
$GLOBALS['table'] = '';
$show_query = '1';
...
if (file_exists('./config')) {
    trigger_error(__('Directory [code]config[/code], which is used by the setup scripts, still exists in your phpMyAdmin directory. You should remove it once phpMyAdmin has been configured.'), E_USER_WARNING);
}
