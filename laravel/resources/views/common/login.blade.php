...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset('static/assets/js/ie8-responsive-file-warning.js') }}"></script><![endif]-->
...
<div class="container">
    <form class="form-signin" action="" method="post">
        ...
        <input type="text" id="email" name="number" value="{{ old('number') }}" class="form-control" placeholder="工号" required autofocus>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6" style="text-align: right;">
                <a class="btn btn-link" data-toggle="modal" data-target="#myModal">忘记密码</a>
            </div>
        </div>
        <br>
