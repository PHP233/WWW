...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/process_style.css">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">中国女医师协会</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">标准申报</a></li>
            <li><a href="#about">申报状态</a></li>
            <li><a href="#contact">意见反馈</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">zjm，你好 <span class="caret"></span></a>
